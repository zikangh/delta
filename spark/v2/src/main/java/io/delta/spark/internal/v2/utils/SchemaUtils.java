...
public class SchemaUtils {
  ...
  /**
   * Projects {@code readDataSchema U partitionSchema} into the table's DDL column order. Fields not
   * present in {@code rawSchema} (e.g. {@code _metadata}) are appended at the tail in insertion
   * order.
   */
